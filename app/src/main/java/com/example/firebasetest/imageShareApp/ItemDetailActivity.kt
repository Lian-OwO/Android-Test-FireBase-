package com.example.firebasetest.imageShareApp
...
import com.example.firebasetest.databinding.ActivityItemDetailBinding
import java.io.File
...
//            var date: String? = null
                ...
                db.collection("AndroidImageShareApp").document("${docId}")
                    ...
                    .addOnSuccessListener {
                        Log.d("scb", "DocumentSnapshot successfully written!")
                        ...
                        desertRef.delete().addOnSuccessListener {
                            ...
                            Log.d("scb", "스토리지 successfully deleted!")
                            ...
                            Log.d("scb", "스토리지 failed deleted!")
                            Toast.makeText(this,"스토리지 삭제 실패", Toast.LENGTH_SHORT).show()
                        }
                    }
                    .addOnFailureListener { e -> Log.w("scb", "Error writing document", e) }
